...
class DebugOptionWidget extends StatefulWidget {
  const DebugOptionWidget({Key? key}) : super(key: key);

  @override
  _DebugOptionWidgetState createState() => _DebugOptionWidgetState();
}

class _DebugOptionWidgetState extends State<DebugOptionWidget> {
                ...
                child: Column(
                  ...
                  children: [
                    SwitchListTile(
                        ...
                        value: _showFeaturePoints, onChanged: (bool value) {
                      setState(() {
                    ...
                    SwitchListTile(
                        ...
                        value: _showPlanes, onChanged: (bool value) {
                      setState(() {
                        _showPlanes = value;
                        updateSessionSettings();
                      });
                    ...
                    SwitchListTile(
                        ...
                        value: _showWorldOrigin, onChanged: (bool value) {
                      setState(() {
